...
module.exports = {
    ...
    async getGoogleBooksResults(term, type) {
        ...
        const searchURL = booksApiUrl + '?q=' + type + ':"' + cleanTerm + '"&orderBy=relevance&maxResults=40&langRestrict=en&printType=books&filter=ebooks&key=' + process.env.GOOGLE_BOOKS_API_KEY;
